...
async def update_electrics_vehicle(brand: str, model: str, vehicle_update: UpdateElectricVehicle):
...
async def delete_electrics_vehicle(brand: str, model: str):
...
async def update_electricitys_price(city: str, electricity_type: str, price_update: UpdateElectricityPrice):
...
@app.delete("/electricity-prices/{city}/{electricity_type}", response_model=DeleteElectricityPrice)
async def delete_electricitys_price(city: str, electricity_type: str):
